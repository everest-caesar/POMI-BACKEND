 ...
 */
export const getAdminMessages = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const adminId = (req as any).userId;
 ...
 */
export const broadcastAdminMessage = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const adminId = (req as any).userId;
 ...
 */
export const getAdminInbox = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const adminId = (req as any).userId;
 ...
 */
export const getAdminConversation = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const adminId = (req as any).userId;
