...
import { createEvent, getEvents, getEvent, updateEvent, deleteEvent, rsvpEvent, cancelRsvp, getUserEvents, getPendingEvents, approveEvent, rejectEvent, } from '../controllers/eventController.js';
const router = Router();
/**
