...
describe('Admin API', () => {
    ...
    beforeAll(async () => {
        ...
        const eventResponse = await request(app)
            ...
            description: 'An opportunity for local professionals to connect and share opportunities.',
        ...
        const businessResponse = await request(app)
            ...
            description: 'Serving authentic Ethiopian coffee and pastries in the heart of Ottawa.',
            category: 'restaurant',
            phone: '613-555-0101',
    ...
    test('should list events with attendee details', async () => {
        ...
        const event = response.body.events.find((item) => item.id === createdEventId);
    ...
    test('should list businesses and allow status updates', async () => {
        ...
        const business = listResponse.body.businesses.find((item) => item.id === createdBusinessId);
