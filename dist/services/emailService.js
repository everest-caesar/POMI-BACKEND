 ...
 */
const sendEventCreationNotification = async (eventTitle, eventDate, organizerName, organizerEmail) => {
    const html = `
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
      <div style="max-width: 600px; margin: 0 auto;">
 ...
 */
const sendBusinessSubmissionNotification = async (businessName, category, ownerName, ownerEmail) => {
    const html = `
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
      <div style="max-width: 600px; margin: 0 auto;">
 ...
 */
const sendListingSubmissionNotification = async (listingTitle, listingPrice, sellerName, sellerEmail) => {
    const html = `
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
      <div style="max-width: 600px; margin: 0 auto;">
...
const sendVerificationCodeEmail = async (email, code, type = 'signup') => {
    const subjectMap = {
